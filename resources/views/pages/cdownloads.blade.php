...
@include('inc.navbar')
    ...
    <div class="main" id="app">
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#uploadc">UPLOAD CATEGORY</a></li>
        ...
        <div class="tab-content">
            ...
            <div id="edit" class="tab-pane fade">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-6 input-group">
                        ...
                        <select name="role" class="form-control">
                            <option value="none" selected disabled><-- Please choose one --></option>
                            <option>Upload one: Revised manual</option>
                            <option>Upload two</option>
                            <option>Upload three</option>
                        </select>
                    </div><hr>
                    ...
                    <form class="cbranch" method="POST" action="/create/download">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6 input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-sort-by-alphabet"></i></span>
                                <input type="text" class="form-control" name="name" value=" " id="inputDescription" placeholder="e.g Revised Manual">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6 input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                <input type="text" name="description" value=" " class="form-control" id="inputDescription" placeholder="e.g Speak words of wisdom today...">
                            </div>
                        </div>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-6 input-group">
                        ...
                        <select name="role" class="form-control">
                            ...
                            <option>Manual 11</option>
                            <option>Manual 111</option>
                            <option>Manual 1111</option>
                        </select>
                    </div>
                </div>
            ...
            <div id="ucdelete" class="tab-pane fade">
                ...
                <div class="form-group col-sm-12">
                    <label for="role" class="col-sm-2 control-label">Upload Category Name</label>
                    <div class="col-sm-6 input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                        <select name="role" class="form-control">
                            <option value="none" selected disabled><-- Please choose one --></option>

    ...
    <div class="main" id="app">
        ...
        <!-- month tab starts here -->
            <div id="month" class="tab-pane fade"><br>
                ...
                <div class="container-fluid"> 
                    <div class="col-sm-3">
                        <table class="table table-m table-striped table-hover table-bordered table-condensed">
                            <thead>
                                <!--here, the days will load onclick generate button -->
                                <tr>
                                    <th scope="col">2015</th>
                    ...
                    <div class="col-sm-3">
                        <table class="table table-m table-striped table-condensed table-hover table-bordered">
                            <thead>
                                <!--here, the days will load onclick generate button -->
                                <tr>
                                    <th scope="col">2016</th>
        ...
        <!-- week tab starts here -->
            <div id="week" class="tab-pane fade"><br>
                ...
                <div class="container-fluid"> 
                    <div class="col-sm-3">
                        <table class="table table-w table-striped table-hover table-bordered table-condensed">
                            <thead>
                                <!--here, the days will load onclick generate button -->
                                <tr>
                                    <th scope="col">2015</th>
                    ...
                    <div class="col-sm-3">
                        <table class="table table-w table-striped table-condensed table-hover table-bordered">
                            <thead>
                                <!--here, the days will load onclick generate button -->
                                <tr>
                                    <th scope="col">2016</th>
